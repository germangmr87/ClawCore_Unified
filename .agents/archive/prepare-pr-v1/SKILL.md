...
- `fix: <summary> (clawcore#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (clawcore#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "clawcore#$pr_number" || { echo "ERROR: commit subject missing clawcore#$pr_number"; exit 1; }
