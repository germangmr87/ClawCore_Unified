## ClawCore Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_clawcore-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm clawcore gateway --port 18789 --verbose
```
