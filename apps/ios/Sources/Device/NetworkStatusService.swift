...
final class NetworkStatusService: @unchecked Sendable {
    func currentStatus(timeoutMs: Int = 1500) async -> ClawCoreNetworkStatusPayload {
    ...
    private static func payload(from path: NWPath) -> ClawCoreNetworkStatusPayload {
        let status: ClawCoreNetworkPathStatus = switch path.status {
    ...
    private static func fallbackPayload() -> ClawCoreNetworkStatusPayload {
        ClawCoreNetworkStatusPayload(
            status: .unsatisfied,
            isExpensive: false,
            isConstrained: false,
            interfaces: [.other])
