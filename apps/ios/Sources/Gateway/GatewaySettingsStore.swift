...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.clawcore.gateway"
    private static let nodeService = "ai.clawcore.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.clawcore.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.clawcore.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("clawcore-gateway.log")
    }
