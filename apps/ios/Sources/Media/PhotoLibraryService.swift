...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: ClawCorePhotosLatestParams) async throws -> ClawCorePhotosLatestPayload {
        ...
        var results: [ClawCorePhotoPayload] = []
        ...
        return ClawCorePhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> ClawCorePhotoPayload
    {
