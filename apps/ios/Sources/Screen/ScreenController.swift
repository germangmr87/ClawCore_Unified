...
final class ScreenController {
    ...
    /// Callback invoked when an clawcore:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = ClawCoreKitResources.bundle
...
/// Handles navigation policy to intercept clawcore:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept clawcore:// deep links.
        if url.scheme?.lowercased() == "clawcore" {
