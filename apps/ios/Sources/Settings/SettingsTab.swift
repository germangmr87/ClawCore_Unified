...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = ClawCoreLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = ClawCoreLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.clawcore.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(ClawCoreLocationMode.off.rawValue)
                            Text("While Using").tag(ClawCoreLocationMode.whileUsing.rawValue)
                            Text("Always").tag(ClawCoreLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while ClawCore is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = ClawCoreLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: ClawCoreLocationMode {
        ClawCoreLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
