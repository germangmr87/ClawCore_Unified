...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/clawcore/clawcore") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/clawcore/clawcore")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://clawcore.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "ClawCoreBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ClawCoreBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "ClawCoreGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "ClawCoreGitCommit") as? String) ??
            "unknown"
    }
