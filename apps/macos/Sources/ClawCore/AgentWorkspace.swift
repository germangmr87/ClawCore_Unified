...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.clawcore", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return ClawCoreConfigFile.defaultWorkspaceURL() }
