...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = ClawCoreConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = ClawCoreConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = ClawCoreConfigFile.loadDict()
            ...
            ClawCoreConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/clawcore"
        state.remoteCliPath = ""
        return state
    }
}
