...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.clawcore", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("ClawCore/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__clawcore__/a2ui/").absoluteString + "?platform=macos"
    }
