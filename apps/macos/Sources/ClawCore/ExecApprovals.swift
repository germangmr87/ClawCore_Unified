...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.clawcore", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        ClawCorePaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        ClawCorePaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
