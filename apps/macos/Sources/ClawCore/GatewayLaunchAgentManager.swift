...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.clawcore", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".clawcore/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.clawcoreCommand(
            subcommand: "gateway",
