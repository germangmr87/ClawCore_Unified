...
enum UIStrings {
    static let welcomeTitle = "Welcome to ClawCore"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "clawcore.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: ClawCoreOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: ClawCoreChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g clawcore@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: ClawCoreChatViewModel(
