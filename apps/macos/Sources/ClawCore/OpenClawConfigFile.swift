...
enum ClawCoreConfigFile {
    private static let logger = Logger(subsystem: "ai.clawcore", category: "config")
    ...
    static func stateDirURL() -> URL {
        ClawCorePaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        ClawCorePaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-clawcore-config-file",
            "event": "config.write",
