...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .clawcoreSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? ClawCorePaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? ClawCorePaths.stateDirURL.path
...
extension Notification.Name {
    static let clawcoreSelectSettingsTab = Notification.Name("clawcoreSelectSettingsTab")
}
