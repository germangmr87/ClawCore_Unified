...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.clawcore", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.clawcore", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [ClawCoreChatMessage] = messages.compactMap { item in
