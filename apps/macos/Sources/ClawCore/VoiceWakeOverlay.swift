...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.clawcore", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other ClawCore windows, but below the system’s pop-up menus.
