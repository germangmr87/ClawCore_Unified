...
public typealias ClawCorePlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias ClawCorePlatformImage = UIImage
#endif

public struct ClawCoreChatUsageCost: Codable, Hashable, Sendable {
...
public struct ClawCoreChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: ClawCoreChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(ClawCoreChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct ClawCoreChatMessageContent: Codable, Hashable, Sendable {
...
public struct ClawCoreChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [ClawCoreChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: ClawCoreChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [ClawCoreChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: ClawCoreChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(ClawCoreChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([ClawCoreChatMessageContent].self, forKey: .content) {
...
public struct ClawCoreChatHistoryPayload: Codable, Sendable {
...
public struct ClawCoreSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct ClawCoreSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [ClawCoreSessionPreviewItem]
}

public struct ClawCoreSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [ClawCoreSessionPreviewEntry]

    public init(ts: Int, previews: [ClawCoreSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct ClawCoreChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct ClawCoreChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct ClawCoreAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct ClawCoreChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct ClawCoreGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct ClawCorePendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: ClawCorePlatformImage?
...
public struct ClawCoreChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
