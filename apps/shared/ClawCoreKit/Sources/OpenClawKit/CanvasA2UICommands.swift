...
public enum ClawCoreCanvasA2UICommand: String, Codable, Sendable {
...
public struct ClawCoreCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct ClawCoreCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
