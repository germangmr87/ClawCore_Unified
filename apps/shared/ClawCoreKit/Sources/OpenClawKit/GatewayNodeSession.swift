...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.clawcore", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.clawcore", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: ClawCoreProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
