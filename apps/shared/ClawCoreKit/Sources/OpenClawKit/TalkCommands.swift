...
public enum ClawCoreTalkCommand: String, Codable, Sendable {
...
public struct ClawCoreTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct ClawCoreTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
