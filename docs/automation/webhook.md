...
read_when:
  ...
  - Wiring external systems into ClawCore
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your ClawCore config directory (typically `~/.clawcore/hooks/transforms`).
...
- `clawcore webhooks gmail setup` writes `hooks.gmail` config for `clawcore webhooks gmail run`.
