...
read_when:
  - You want ClawCore to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables ClawCore to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`clawcore onboard`) and `clawcore channels add` list optional channel plugins.
...
```bash
clawcore plugins install @clawcore/nostr
```

Use a local checkout (dev workflows):

```bash
clawcore plugins install --link <path-to-clawcore>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "clawcore",
        "displayName": "ClawCore",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "clawcore@example.com",
        "lud16": "clawcore@example.com"
      }
    }
  }
}
