...
- Install via CLI: `clawcore plugins install @clawcore/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `clawcore plugins install ./extensions/zalo`
   - From npm (if published): `clawcore plugins install @clawcore/zalo`
...
- Approve via:
  - `clawcore pairing list zalo`
  - `clawcore pairing approve zalo <CODE>`
...
- Example: `clawcore message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `clawcore channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `clawcore logs --follow`
