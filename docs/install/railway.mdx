...
Deploy ClawCore on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/clawcore` — Control UI
...
- `CLAWCORE_STATE_DIR=/data/.clawcore` (recommended)
- `CLAWCORE_WORKSPACE_DIR=/data/workspace` (recommended)
- `CLAWCORE_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your ClawCore state + workspace so you can migrate to another host without losing config or memory.
