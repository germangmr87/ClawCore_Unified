...
ClawCore treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.clawcore/settings/voicewake.json`

Shape:

```json
{ "triggers": ["clawcore", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
