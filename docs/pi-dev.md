...
This guide summarizes a sane workflow for working on the pi integration in ClawCore.
...
- Trigger the agent directly:
  - `pnpm clawcore agent --message "Hello" --thinking low`
...
State lives under the ClawCore state directory. Default is `~/.clawcore`. If `CLAWCORE_STATE_DIR` is set, use that directory instead.

To reset everything:

- `clawcore.json` for config
...
- [https://docs.clawcore.ai/testing](https://docs.clawcore.ai/testing)
- [https://docs.clawcore.ai/start/getting-started](https://docs.clawcore.ai/start/getting-started)
