...
- Same path: run the app from a fixed location (for ClawCore, `dist/ClawCore.app`).
...
Workaround: move files into the ClawCore workspace (`~/.clawcore/workspace`) if you want to avoid per-folder grants.
