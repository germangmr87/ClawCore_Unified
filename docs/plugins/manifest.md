...
read_when:
  - You are building a ClawCore plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (clawcore.plugin.json)

Every plugin **must** ship a `clawcore.plugin.json` file in the **plugin root**.
ClawCore uses this manifest to validate configuration **without executing plugin
