...
You can point ClawCore at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or ClawCore
...
- [Anthropic provider](/providers/anthropic) - Native ClawCore integration with Claude setup-token or API keys
