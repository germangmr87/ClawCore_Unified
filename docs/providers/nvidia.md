---
summary: "Use NVIDIA's OpenAI-compatible API in ClawCore"
read_when:
  - You want to use NVIDIA models in ClawCore
...
clawcore onboard --auth-choice skip
clawcore models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
