---
summary: "Use Qianfan's unified API to access many models in ClawCore"
read_when:
...
3. ClawCore installed on your system
...
4. Copy the API key for use with ClawCore

## CLI setup

```bash
clawcore onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ClawCore Configuration](/gateway/configuration)
