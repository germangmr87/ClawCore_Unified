---
summary: "Use Qwen OAuth (free tier) in ClawCore"
read_when:
  - You want to use Qwen with ClawCore
...
If you already logged in with the Qwen Code CLI, ClawCore will sync credentials
