---
summary: "Use Synthetic's Anthropic-compatible API in ClawCore"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. ClawCore registers it as the
...
Note: ClawCore's Anthropic client appends `/v1` to the base URL, so use
