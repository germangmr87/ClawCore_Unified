---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ClawCore"
read_when:
  - You want Xiaomi MiMo models in ClawCore
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ClawCore uses
