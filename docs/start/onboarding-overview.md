---
summary: "Overview of ClawCore onboarding options and flows"
read_when:
...
ClawCore supports multiple onboarding paths depending on where the Gateway runs
...
- [`clawcore onboard` command](/cli/onboard)

## macOS app onboarding

Use the ClawCore app when you want a fully guided setup on macOS. Docs:
