---
summary: "First-run onboarding flow for ClawCore (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give ClawCore">
...
<Step title="CLI">
  ...
  The app can install the global `clawcore` CLI via npm/pnpm so terminal
