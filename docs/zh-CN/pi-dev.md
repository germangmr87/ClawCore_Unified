...
本指南总结了在 ClawCore 中开发 Pi 集成的合理工作流程。
...
状态存储在 ClawCore 状态目录下。默认为 `~/.clawcore`。如果设置了 `CLAWCORE_STATE_DIR`，则使用该目录。
...
- https://docs.clawcore.ai/testing
- https://docs.clawcore.ai/start/getting-started
