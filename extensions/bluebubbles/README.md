...
This directory contains the **BlueBubbles external channel plugin** for ClawCore.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `clawcore/plugin-sdk` helpers.
