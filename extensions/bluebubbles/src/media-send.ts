...
import { resolveChannelMediaMaxBytes, type ClawCoreConfig } from "clawcore/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: ClawCoreConfig; accountId?: string }): string[] {
