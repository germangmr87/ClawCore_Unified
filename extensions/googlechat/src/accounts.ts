...
export function listGoogleChatAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: ClawCoreConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: ClawCoreConfig): ResolvedGoogleChatAccount[] {
