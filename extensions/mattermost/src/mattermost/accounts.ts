...
export function listMattermostAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: ClawCoreConfig): string {
...
export function listEnabledMattermostAccounts(cfg: ClawCoreConfig): ResolvedMattermostAccount[] {
