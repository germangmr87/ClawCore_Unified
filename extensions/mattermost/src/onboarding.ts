import type { ChannelOnboardingAdapter, ClawCoreConfig, WizardPrompter } from "clawcore/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.clawcore.ai/channels/mattermost",
    ].join("\n"),
