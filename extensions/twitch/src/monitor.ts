...
import type { ReplyPayload, ClawCoreConfig } from "clawcore/plugin-sdk";
import { createReplyPrefixOptions } from "clawcore/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as ClawCoreConfig;
