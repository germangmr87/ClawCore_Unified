...
- Version alignment with core ClawCore release numbers.
...
- First public release of the @clawcore/voice-call plugin.
...
- CLI: `clawcore voicecall` commands (call/start/continue/speak/end/status/tail/expose).
