...
export function listZalouserAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: ClawCoreConfig): string {
...
function mergeZalouserAccountConfig(cfg: ClawCoreConfig, accountId: string): ZalouserAccountConfig {
