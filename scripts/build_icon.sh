...
# Defaults target the ClawCore assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/ClawCore/Resources/ClawCore.icns"}
