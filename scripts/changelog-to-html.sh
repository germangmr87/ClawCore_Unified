...
if [[ -z "$version_content" ]]; then
  echo "<h2>ClawCore $VERSION</h2>"
  echo "<p>Latest ClawCore update.</p>"
  echo "<p><a href=\"https://github.com/clawcore/clawcore/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
