...
show_usage() {
    cat << EOF
clawlog - ClawCore Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View ClawCore logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    ClawCore logs flow through the macOS unified log (subsystem: ai.clawcore).
