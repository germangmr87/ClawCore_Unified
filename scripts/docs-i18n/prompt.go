...
- Keep product names in English: ClawCore, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ClawCore Gateway, use “Gateway 网关”.
