...
# Output:
# - dist/ClawCore.app
# - dist/ClawCore-<version>.zip
# - dist/ClawCore-<version>.dmg
...
APP="$ROOT_DIR/dist/ClawCore.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/ClawCore-$VERSION.zip"
DMG="$ROOT_DIR/dist/ClawCore-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/ClawCore-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/ClawCore-$VERSION.dSYM.zip"
