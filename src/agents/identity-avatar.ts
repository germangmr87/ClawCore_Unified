...
function resolveAvatarSource(cfg: ClawCoreConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: ClawCoreConfig, agentId: string): AgentAvatarResolution {
