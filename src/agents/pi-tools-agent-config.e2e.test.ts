...
describe("Agent-specific tool filtering", () => {
  ...
  it("should apply global tool policy when no agent-specific policy exists", () => {
    ...
    const tools = createClawCoreCodingTools({
      config: cfg,
  ...
  it("defaults apply_patch to workspace-only (blocks traversal)", async () => {
    const workspaceDir = await fs.mkdtemp(path.join(os.tmpdir(), "clawcore-pi-tools-"));
...
*** End Patch`;
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createClawCoreCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createClawCoreCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createClawCoreCodingTools({
      config: cfg,
    ...
    const defaultTools = createClawCoreCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createClawCoreCodingTools({
      config: cfg,
    ...
    const bobTools = createClawCoreCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createClawCoreCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createClawCoreCodingTools({
      config: cfg,
