...
describe("createClawCoreCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createClawCoreCodingTools({
      config,
    ...
    const anthropicTools = createClawCoreCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createClawCoreCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createClawCoreCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
