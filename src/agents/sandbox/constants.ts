...
export const DEFAULT_SANDBOX_IMAGE = "clawcore-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "clawcore-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "clawcore-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "clawcore-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "clawcore-sbx-browser-";
