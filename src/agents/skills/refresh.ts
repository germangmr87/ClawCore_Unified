...
function resolveWatchPaths(workspaceDir: string, config?: ClawCoreConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: ClawCoreConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: ClawCoreConfig }) {
