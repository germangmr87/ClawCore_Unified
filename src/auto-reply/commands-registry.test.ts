...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@clawcore", { botUsername: "clawcore" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@clawcore args", {
        botUsername: "clawcore",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@clawcore: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "clawcore" })).toBe(
      "/help@otherbot",
    );
  });
