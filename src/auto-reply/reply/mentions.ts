...
function resolveMentionPatterns(cfg: ClawCoreConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: ClawCoreConfig | undefined, agentId?: string): RegExp[] {
