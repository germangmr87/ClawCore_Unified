...
export const A2UI_PATH = "/__clawcore__/a2ui";

export const CANVAS_HOST_PATH = "/__clawcore__/canvas";

export const CANVAS_WS_PATH = "/__clawcore__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.clawcoreCanvasA2UIAction.postMessage(...)
  // - Android: window.clawcoreCanvasA2UIAction.postMessage(...)
  const handlerNames = ["clawcoreCanvasA2UIAction"];
  ...
  globalThis.ClawCore = globalThis.ClawCore ?? {};
  globalThis.ClawCore.postMessage = postToNode;
  globalThis.ClawCore.sendUserAction = sendUserAction;
  globalThis.clawcorePostMessage = postToNode;
  globalThis.clawcoreSendUserAction = sendUserAction;
