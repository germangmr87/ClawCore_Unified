...
import type { ClawCorePackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverClawCorePlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, ClawCorePackageManifest>>;
...
const ENV_CATALOG_PATHS = ["CLAWCORE_PLUGIN_CATALOG_PATHS", "CLAWCORE_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<ClawCorePackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: ClawCorePackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: ClawCorePackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverClawCorePlugins({ workspaceDir: options.workspaceDir });
