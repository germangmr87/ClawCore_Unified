...
function setSlackDmPolicy(cfg: ClawCoreConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "ClawCore";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for ClawCore`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: ClawCoreConfig, allowFrom: string[]): ClawCoreConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
