...
export type ChannelAgentToolFactory = (params: { cfg?: ClawCoreConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: ClawCoreConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: ClawCoreConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: ClawCoreConfig }) => boolean;
  supportsCards?: (params: { cfg: ClawCoreConfig }) => boolean;
