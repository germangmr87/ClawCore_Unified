...
const SANDBOX_EXAMPLES = {
  main: [
    ["clawcore sandbox list", "List all sandbox containers."],
    ["clawcore sandbox list --browser", "List only browser containers."],
    ["clawcore sandbox recreate --all", "Recreate all containers."],
    ["clawcore sandbox recreate --session main", "Recreate a specific session."],
    ["clawcore sandbox recreate --agent mybot", "Recreate agent containers."],
    ["clawcore sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["clawcore sandbox list", "List all sandbox containers."],
    ["clawcore sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["clawcore sandbox recreate --all", "Recreate all containers."],
    ["clawcore sandbox recreate --session main", "Recreate a specific session."],
    ["clawcore sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["clawcore sandbox recreate --browser --all", "Recreate only browser containers."],
    ["clawcore sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["clawcore sandbox explain", "Show effective sandbox config."],
    ["clawcore sandbox explain --session agent:main:main", "Explain a specific session."],
    ["clawcore sandbox explain --agent work", "Explain an agent sandbox."],
    ["clawcore sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.clawcore.ai/cli/sandbox")}\n`,
    )
    .action(() => {
