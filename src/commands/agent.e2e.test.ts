...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "clawcore-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ClawCoreConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ClawCoreConfig["telegram"]>>,
