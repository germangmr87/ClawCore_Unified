...
function resolveDefaultAccountId(cfg: ClawCoreConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: ClawCoreConfig): boolean {
...
export function summarizeBindings(cfg: ClawCoreConfig, bindings: AgentBinding[]): string[] {
