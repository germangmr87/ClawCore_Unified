...
const ensureClawCoreModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveClawCoreAgentDir = vi.fn().mockReturnValue("/tmp/clawcore-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/clawcore-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureClawCoreModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveClawCoreAgentDir,
}));
