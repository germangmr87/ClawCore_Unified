...
export function applyOpenrouterProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyMoonshotConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: ClawCoreConfig): ClawCoreConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: ClawCoreConfig): ClawCoreConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: ClawCoreConfig): ClawCoreConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyQianfanProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: ClawCoreConfig): ClawCoreConfig {
