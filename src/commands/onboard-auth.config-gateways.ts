...
export function applyVercelAiGatewayProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyVercelAiGatewayConfig(cfg: ClawCoreConfig): ClawCoreConfig {
