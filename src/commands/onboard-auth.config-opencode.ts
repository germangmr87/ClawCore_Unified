...
export function applyOpencodeZenProviderConfig(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyOpencodeZenConfig(cfg: ClawCoreConfig): ClawCoreConfig {
