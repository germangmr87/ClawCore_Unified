...
function resolveAnthropicDefaultAuthMode(cfg: ClawCoreConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyTalkApiKey(config: ClawCoreConfig): ClawCoreConfig {
...
export function applyModelDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyLoggingDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyContextPruningDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
...
export function applyCompactionDefaults(cfg: ClawCoreConfig): ClawCoreConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
