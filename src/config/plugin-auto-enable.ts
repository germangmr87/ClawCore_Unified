import type { ClawCoreConfig } from "./config.js";
...
function isTelegramConfigured(cfg: ClawCoreConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ClawCoreConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: ClawCoreConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ClawCoreConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ClawCoreConfig): boolean {
...
function isIMessageConfigured(cfg: ClawCoreConfig): boolean {
...
function isWhatsAppConfigured(cfg: ClawCoreConfig): boolean {
...
function isGenericChannelConfigured(cfg: ClawCoreConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: ClawCoreConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: ClawCoreConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: ClawCoreConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: ClawCoreConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: ClawCoreConfig, pluginId: string): ClawCoreConfig {
...
function registerPluginEntry(cfg: ClawCoreConfig, pluginId: string): ClawCoreConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
