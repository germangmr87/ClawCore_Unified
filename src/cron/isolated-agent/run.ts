...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/clawcore/clawcore/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.CLAWCORE_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.clawcore/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: ClawCoreConfig = {
    ...params.cfg,
