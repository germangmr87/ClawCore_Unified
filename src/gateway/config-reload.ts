...
import type { ClawCoreConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: ClawCoreConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: ClawCoreConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ClawCoreConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ClawCoreConfig) => void;
  log: {
