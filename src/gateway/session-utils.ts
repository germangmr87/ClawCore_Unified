...
import { type ClawCoreConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: ClawCoreConfig): string[] {
...
export function listAgentsForGateway(cfg: ClawCoreConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: ClawCoreConfig): string {
...
function resolveSessionStoreAgentId(cfg: ClawCoreConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: ClawCoreConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: ClawCoreConfig): GatewaySessionsDefaults {
