...
import { createClawCoreTools } from "../agents/clawcore-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-clawcore-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-clawcore-account-id")?.trim() || undefined;
  ...
  const allTools = createClawCoreTools({
