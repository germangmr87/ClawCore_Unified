...
import type { ClawCorePluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ClawCorePluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ClawCorePluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
