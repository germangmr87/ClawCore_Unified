...
export type { ClawCoreConfig } from "../config/config.js";
/** @deprecated Use ClawCoreConfig instead */
export type { ClawCoreConfig as ClawdbotConfig } from "../config/config.js";
