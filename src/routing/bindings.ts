...
export function listBindings(cfg: ClawCoreConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: ClawCoreConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: ClawCoreConfig) {
