...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof ClawCoreConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: ClawCoreConfig; env: NodeJS.ProcessEnv }): {
  cfg: ClawCoreConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
