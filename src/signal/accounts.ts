...
export function listSignalAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ClawCoreConfig): string {
...
function mergeSignalAccountConfig(cfg: ClawCoreConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: ClawCoreConfig): ResolvedSignalAccount[] {
