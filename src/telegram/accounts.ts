...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.CLAWCORE_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: ClawCoreConfig): string {
...
function mergeTelegramAccountConfig(cfg: ClawCoreConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: ClawCoreConfig): ResolvedTelegramAccount[] {
