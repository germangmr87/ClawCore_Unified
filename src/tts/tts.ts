...
export function resolveTtsConfig(cfg: ClawCoreConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.CLAWCORE_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: ClawCoreConfig): string | undefined {
