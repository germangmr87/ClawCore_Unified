...
function listConfiguredAccountIds(cfg: ClawCoreConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: ClawCoreConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: ClawCoreConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: ClawCoreConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: ClawCoreConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: ClawCoreConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: ClawCoreConfig): ResolvedWhatsAppAccount[] {
